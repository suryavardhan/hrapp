            ...
            <div class="widget_body">
              <table class="activity_datatable" width="100%" border="0" cellspacing="0" cellpadding="8"> 
				...
				<tr>
				    ...
				    <td><?=$row->email;?></td>
				    <td><?=$this->candidatesmodel->show_candidate_countAssignedtests($row->user_id);?></td>
				    <td>
				    ...
				    <td>
				    	...
				    	<a class="confirm" href="<?=site_url('secure/candidates/reactivate/'.$row->user_id);?>" title="You want to reactivate the candidate!">û</a>  			
