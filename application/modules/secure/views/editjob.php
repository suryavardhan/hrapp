...
<?php $this->load->view('messages'); ?>	
 ...
 <div class="one_wrap">
    	...
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">C</span><h5>Edit job listing</h5></div>
            <div class="widget_body">

<!-- Form -->
          <form action="<?=site_url(); ?>secure/job/update" method="post" enctype="multipart/form-data" name="myform" id="myform" autocomplete="off">
	            <input name="job_id" value="<?=$job_id;?>" type="hidden"/> 
	            <ul class="form_fields_container">
	            	<li><label>Job Title</label> 
	            		<div class="form_input">
	            			<input type="text" size="40" name="title" class="input-text" value="<?=$job_data->job_title ;?>" />
					...
					<li>
						...
						<div class="form_input">
							<textarea name="jobintro" id="jobintro" size="45"><?=$job_data->introduction;?></textarea>
					...
					<li>
						...
						<div class="form_input">
							<textarea name="responsibilities" id="responsibilities" size="45">
					...
					<li>
						...
						<div class="form_input">
							<textarea name="skillset" id="skillset" class="input-text" size="45">
                              <?=$job_data->skillset;?></textarea>
							</textarea>
                        </div>
                ...
                <div class="action_bar">
                 <input type="submit" class="button_small bluishBtn" value="Update Job" />
                </div>							
			</form>
