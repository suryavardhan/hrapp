...
<div class="one_wrap">
        ...
        <div class="widget">
            ...
            <form action="<?=site_url('secure/candidates/save_interview'); ?>" method="post" enctype="multipart/form-data" name="myform" id="myform" autocomplete="off">	
              ...
              <ul class="form_fields_container">
	            	...
	            	<li><label>Expected Pay</label>
	            		<div class="form_input">
                          <input type="text" name="expected_pay" />
	            		</div>      		
	            	</li>
	            	<li><label>Current Pay</label>
	            		<div class="form_input">
                          <input type="text" name="current_pay" />
	            		</div>      		
	            	</li>
