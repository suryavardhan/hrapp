...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'SupportSages';
$config['webmaster_email'] = 'hr@supportsages.com';
...
$config['recaptcha_public_key'] = '6Lezv9ESAAAAAPoRYFp0lmjiJ8BDaUK6p8aOHrc6';
$config['recaptcha_private_key'] = '6Lezv9ESAAAAAFS26XhJ-IbngdPPlanv5yxQO8w5';
